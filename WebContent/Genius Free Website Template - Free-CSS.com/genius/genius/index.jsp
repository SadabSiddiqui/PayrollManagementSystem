                ...
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.html"><img src="images/logo-normal.png" alt=""></a>
                              ...
                              <li><a href="C:\Users\hp\eclipse-workspace\Tr\WebContent\Registration form\index.html">Contact</a></li>
                        </ul>
            ...
            <div class="vertical-header-wrapper">
                <nav class="nav-menu">
                    ...
                    <ul class="primary-menu">
                        <li class="child-menu"><a href="C:\Users\hp\eclipse-workspace\Tr\WebContent\Registration form\index.html">Add_Employee <i class="fa fa-angle-right"></i></a>
                          <li class="child-menu"><a href="#">Employee_List <i class="fa fa-angle-right"></i></a>
                    </ul>
